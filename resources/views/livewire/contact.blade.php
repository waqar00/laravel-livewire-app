            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li  class="list-inline-item"><a wire:navigate href="/">Home</a>
                        </li>
                                ...
                                <div class="contact-form">
                                    <form wire:submit='submit'>
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model='name' type="text" class="form-control shadow-none @error('name') is-invalid @enderror" id="contact_name">
                                            @error('name')
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model='email' type="email" class="form-control shadow-none @error('email') is-invalid @enderror" id="contact_email">
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="exampleFormControlTextarea1" class="form-label">Write Message</label>
                                            <textarea wire:model='message' class="form-control shadow-none @error('message') is-invalid @enderror"  rows="3"></textarea>
                                            @error('message')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                        </div>

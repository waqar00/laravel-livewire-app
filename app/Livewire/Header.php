                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                                <li class="nav-item"> <a wire:navigate.hover class="nav-link" href="/">Home</a></li>
                                ...
                                <li class="nav-item "><a wire:navigate class="nav-link " href="{{ route('articles') }}">Blog</a></li>
                                <li class="nav-item "><a wire:navigate class="nav-link " href="{{ route('faqs') }}">FAQ</a></li>
                            </ul>
                            <a wire:navigate href="{{ route('contacts') }}" class="btn btn-outline-primary">Contact Us</a>
                        </div>
                    </div>
                </nav>
            </header>
